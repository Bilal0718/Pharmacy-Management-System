...
public class Renew_Validity extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String date = exp_day.getSelectedItem() + "-" + exp_month.getSelectedItem() + "-" + exp_year.getSelectedItem();
        ...
        if (barcode.getText().equals("") || pro_day.getSelectedIndex() == 0
            ...
            if (check_expiry()) { // if drug is expired it will not be execute
                String sql = "update drugs set PRODUCTION_DATE='" +  pro_year.getSelectedItem() + "-"
                        + pro_month.getSelectedItem() + "-" +pro_day.getSelectedItem() + "' , EXPIRATION_DATE='"
                        + exp_year.getSelectedItem() + "-" + exp_month.getSelectedItem() + "-" + exp_day.getSelectedItem()
                        + "' ,EXPIRY='Available for use' where BARCODE='" + barcode.getText() + "' ";
                try {
                    pre = con.prepareStatement(sql);
                    pre.execute();
