...
public class User extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3.add(day, new org.netbeans.lib.awtextra.AbsoluteConstraints(151, 110, 60, -1));
        ...
        jLabel10.setText("(2) User ID is Non-Adjustable...");
    ...
    private void adduserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_adduserActionPerformed
        ...
        if (name.getText().length() == 0 || !name.getText().matches("[a-zA-Z]+(\\s[a-zA-Z]+)*")) {
        ...
        } else if (address.getText().length() == 0 || !address.getText().matches("[a-zA-Z]+(\\s[a-zA-Z]+)*")) {
            JOptionPane.showMessageDialog(this, "Invalid Name!");
        } else if (id.getText().length() == 0 || !id.getText().matches("\\d+")) {
            JOptionPane.showMessageDialog(this, "Invalid id!");
        } else if (phone.getText().length() == 0 || !phone.getText().matches("\\d+")) {
            JOptionPane.showMessageDialog(this, "Invalid Cost Price!");
        } else if (salary.getText().length() == 0 || !salary.getText().matches("\\d+")) {
            JOptionPane.showMessageDialog(this, "Invalid Amount!");
        } else if (day.getSelectedIndex() == 0 || month.getSelectedIndex() == 0 || year.getSelectedIndex() == 0 || password.getText().equals("")) {
            ...
            if (password.getText().length() < 6) {
                ...
                try {
                    ...
                    pre.execute();
                    JOptionPane.showMessageDialog(null, "User has been Added Successfully", "Successful", 1);
                    clear();
                } catch (Exception e) {
